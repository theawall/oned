...
TODO 2a. Define an object "cirle" with variables x,y
    ...
    I assume the instructions are wrong because area of a circle is
    pi * radius^2, not 2 * pi * radius^2. Also I only get the correct
    output if I do pi * radius^2.
...
TODO 2b. Define an object "rectangle" with variables x1,x2,y1,y2
   ...
   I'm guessing x1, x2, y1, and y2 are coordinates and not lengths?
|#
